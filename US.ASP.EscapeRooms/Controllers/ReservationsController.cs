...
namespace US.ASP.EscapeRooms.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var appDbContext = _context.Rooms;//_context.Reservations.Include(r => r.Room);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomId,DateTime,FirstName,LastName,Email,Phone,Description")] Reservation reservation)
        {
